    ...
    <fieldset class="fieldSetStyle">
        ...
        <table width="80%" style="border: 1px solid #E5E5E5; text-align: center; vertical-align: middle;" align="center">
            <tr>
                ...
                <td align="left">
                    <asp:TextBox runat="server" CssClass="aspTextBox" ID="protocolIDTxt" MaxLength="14"></asp:TextBox>
                    <span>
                        <asp:RequiredFieldValidator runat="server" ID="protocolIdValidator" CssClass="validator" ControlToValidate="protocolIDTxt" Display="Dynamic" ErrorMessage="必填！" ValidationGroup="grpSearch"></asp:RequiredFieldValidator>
                ...
                <td align="left">
                    <asp:TextBox runat="server" CssClass="aspBillAccount" ID="billAccountTxt" Width="200px" MaxLength="23"></asp:TextBox>
                    <span>
                        <asp:RequiredFieldValidator runat="server" ID="accountValidator" CssClass="validator" ControlToValidate="billAccountTxt" Display="Dynamic" ErrorMessage="必填！" ValidationGroup="grpSearch"></asp:RequiredFieldValidator>
                        <ajaxToolkit:RoundedCornersExtender ID="accountCornerEx" runat="server" TargetControlID="billAccountTxt" Radius="5" BorderColor="#4684af" />
                    </span>
        ...
        <table width="80%" style="border: 1px solid #E5E5E5; text-align: center;" align="center" >
            <tr>
                ...
                <td align="left">
                        ...
                        <span><ajaxToolkit:RoundedCornersExtender ID="drawDateCornerEx" runat="server" TargetControlID="drawDateTxt" Radius="5" BorderColor="#4684af" /></span>
                ...
                <td align="left">
                    <span><asp:TextBox runat="server" ID="moneyDrawTxt" CssClass="aspTextBox"></asp:TextBox></span>
                    <span>
                        <asp:RequiredFieldValidator runat="server" ID="moneyValidator" CssClass="validator" ControlToValidate="moneyDrawTxt" Display="Dynamic" ErrorMessage="必填！"></asp:RequiredFieldValidator>
                        <ajaxToolkit:RoundedCornersExtender ID="moneyDrawCornerEx" runat="server" TargetControlID="moneyDrawTxt" Radius="5" BorderColor="#4684af" />
                    </span>
                </td>
            ...
            <tr>
                ...
                <td align="left" colspan="7">
                    <asp:TextBox runat="server" ID="sectionTxt" CssClass="aspTextBox" ReadOnly="True" Width="100%"></asp:TextBox>
                    <ajaxToolkit:RoundedCornersExtender ID="sectionCornerEx" runat="server" TargetControlID="sectionTxt" Radius="5" BorderColor="#4684af" />
                </td>
            </tr>
            <tr>
                <td align="right"><span class="label">系统本息：</span></td>
                <td align="left">
                    <asp:TextBox runat="server" ID="systemTxt" CssClass="aspTextBox" ReadOnly="True"></asp:TextBox>
                    <ajaxToolkit:RoundedCornersExtender ID="systemCornerEx" runat="server" TargetControlID="systemTxt" Radius="5" BorderColor="#4684af" />
                </td>
                <td></td>
                <td align="right"><span class="label">靠档本息：</span></td>
                <td align="left">
                    <asp:TextBox runat="server" ID="totalInterestTxt" CssClass="aspTextBox" ReadOnly="True"></asp:TextBox>
                    <ajaxToolkit:RoundedCornersExtender ID="totalInterestCornerEx" runat="server" TargetControlID="totalInterestTxt" Radius="5" BorderColor="#4684af" />
                </td>
                <td align="right"><h3 style="color:red;">应补利息：</h3></td>
                <td align="left">
                    <asp:TextBox runat="server" ID="marginTxt" CssClass="aspTextBox" ReadOnly="True"></asp:TextBox>
                    <ajaxToolkit:RoundedCornersExtender ID="marginCornerEx" runat="server" TargetControlID="marginTxt" Radius="5" BorderColor="#4684af" />
                </td>
            </tr>
            </table>
    </fieldset>
