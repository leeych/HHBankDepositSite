...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .txtBox { text-align: center; width: 80%; height: 30px; font-size: 18px; font-family: Arial; }
            ...
            <tr><td colspan="2">&nbsp;</td></tr>
                <table align="center">
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="hiddenLinkBtn" runat="server" OnClick="hiddenLinkBtn_Click" Width="0px"></asp:LinkButton></td>
